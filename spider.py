...
#This function is just to return the webpage contents; the source of the webpage when a url is given.
def get_page(url):
	try:
...
# The union function merges the second list into first, with out duplicating an element of a, 
# if it's already in a. Similar to set union operator. This function does not change b. If 
# a=[1,2,3] b=[2,3,4]. After union(a,b) makes a=[1,2,3,4] and b=[2,3,4]
def union(a,b):
	for e in b:
		if e not in a:
			a.append(e)
